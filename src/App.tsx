...
const runWorkflow=useCallback(async()=>{
  ...
  (isFirst
    ...
    :"MID-LEVEL: You are reviewing the previous level output as a critical, senior "+role.dl+" expert. DO NOT restate or repeat what was already said. Instead: (1) Identify 2-3 specific gaps, errors, or unrealistic assumptions in the previous output - be direct and critical. (2) If current real-world data (rates, regulations, benchmarks, competitor info, market figures) would materially improve this, search for it and cite what you found. (3) Add ONE substantive new dimension that only someone at your level would contribute - do not just add more of the same. (4) Output ONLY: a short Critical Review section (your gaps and corrections), then New Contribution (your unique addition), then an updated consolidated summary table. Be concise - quality over length."
