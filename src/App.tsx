...
const runWorkflow=useCallback(async()=>{
  ...
  (isFirst
    ...
    :isLast
    ?"FINAL APPROVAL: Review all previous levels. Produce DEFINITIVE FINAL OUTPUT. Sections: Chain Review, Corrections, FINAL APPROVED OUTPUT, Strategic Commentary, Cross-functional Actions.\n\nDELIVERABLE PACK (produce the actual items, not descriptions):\n1. 30-DAY CONTENT CALENDAR as a markdown table with columns: Date | Platform | Content Type | Caption | Hashtags | CTA. Minimum 12 rows. Write real captions, not placeholders.\n2. THREE READY-TO-POST CAPTIONS written in full: one for Instagram, one for LinkedIn, one for Twitter. Publication-ready, not templates.\n3. CREATIVE BRIEF: one paragraph for the visual designer covering visual direction, colors, mood, and style.\n\nAFTER finishing the above, on its own new line write exactly: ===CAPABILITY_BRIEF===\nThen output ONLY a single valid JSON object:\n{\"info_needed\":[\"...\"],\"tools_required\":[{\"name\":\"...\",\"available\":true,\"why\":\"...\"}],\"manual_steps\":[\"...\"],\"automated_steps\":[\"...\"],\"est_cost_usd\":0,\"notes\":\"...\"}"
    :"MID-LEVEL: You are reviewing the previous level output as a critical, senior "+role.dl+" expert. DO NOT restate or repeat what was already said. Instead: (1) Identify 2-3 specific gaps, errors, or unrealistic assumptions in the previous output - be direct and critical. (2) You MUST search for and cite at least ONE piece of specific current data that the previous level did not have - for example: actual current Meta/Google ad CPM or CPC rates for this industry in the company's location, real competitor social media activity or ad spend, current influencer rate cards, or platform-specific engagement benchmarks published in the last 12 months. Use the company's location and market context to make data specific and locally relevant. Do not use generic global averages - find something specific and actionable for this market. (3) Add ONE substantive new dimension that only someone at your level would contribute - do not just add more of the same. (4) Output ONLY: a short Critical Review section (your gaps and corrections), then New Contribution (your unique addition), then an updated consolidated summary table. Be concise - quality over length."
